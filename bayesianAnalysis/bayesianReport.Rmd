...
\vspace{1mm}
\footnotesize
```{r dag1,echo=TRUE,eval=TRUE,fig.align = "center",cache=TRUE, fig.show = "hold", out.width = "100%"}
dag <- dagitty("
  dag{
  CDS -> ADS -> IC  ons
               U [unobserved]   
...
```{r dag2,echo=TRUE,eval=TRUE,fig.align = "center",cache=TRUE, fig.show = "hold", out.width = "100%"}
dag2 <- dagitty("
  dag{
                CDS -> ADS -> IC  ons
                U [unobserved]   
