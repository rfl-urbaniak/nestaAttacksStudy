...
Hate <- readRDS(file = "data/raw/Hate.rds")
Comments <-   readRDS(file = "data/raw/Comments.rds")
summaries <- read.csv(file = "data/Summaries.csv")
...
interventions <- readRDS(file = "data/interventions.rds")
...
hateDFs <- readRDS("data/hateDFsNoDropouts.RDS")
...
#saveRDS(prior, file = "data/prior1.RDS")
prior <- readRDS(file = "data/prior1.RDS")
...
data <- expand.grid(ADS = ADS,groupID = groupID, CBS = CBS, IC =  IC)
#prior <- extract.prior(InteractionsModelDiffSD1, n = 1e4)
#saveRDS(prior, file = "data/prior2.RDS")
prior <- readRDS(file = "data/prior2.RDS")
mu <- link(InteractionsModelDiffSD1 , post=prior , data=data )
...
#saveRDS(prior, file = "data/prior3.RDS")
prior <- readRDS(file = "data/prior3.RDS")
...
data <- expand.grid(ADS = ADS,groupID = groupID, CBS = CBS, IC =  IC)
#prior <- extract.prior(InteractionsModelDiff, n = 1e4)
#saveRDS(prior, file = "data/prior4.RDS")
prior <- readRDS(file = "data/prior4.RDS")
mu <- link(InteractionsModelDiff , post=prior , data=data )
mu.mean <- apply( mu , 2, mean )
mu.HPDI <- data.frame(t(apply( mu , 2 , HPDI )))
priorDF <- cbind(data, mu.mean, mu.HPDI)
...
hateDFs <- readRDS(file ="data/hateDFs2.RDS")
sampleDFs <- hateDFs

d1precis <- readRDS("data/timeSeriesDFs/d1precis.rds")
d2precis <- readRDS("data/timeSeriesDFs/d2precis.rds")
d3precis <- readRDS("data/timeSeriesDFs/d3precis.rds")
d4precis <- readRDS("data/timeSeriesDFs/d4precis.rds")
d5precis <- readRDS("data/timeSeriesDFs/d5precis.rds")
d6precis <- readRDS("data/timeSeriesDFs/d6precis.rds")
d7precis <- readRDS("data/timeSeriesDFs/d7precis.rds")
...
datA <- readRDS(file = "data/timeSeries/datA.RDS")
fitA <- readRDS("data/timeSeries/c3interactionStanFitA.rds")
datB <- readRDS(file = "data/timeSeries/datB.RDS")
fitB <- readRDS("data/timeSeries/c3interactionStanFitB.rds")
datC <- readRDS(file = "data/timeSeries/datC.RDS")
fitC <- readRDS("data/timeSeries/c3interactionStanFitC.rds")
datD <- readRDS(file = "data/timeSeries/datD.RDS")
fitD <- readRDS("data/timeSeries/c3interactionStanFitD.rds")
